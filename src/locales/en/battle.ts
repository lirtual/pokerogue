...
export const battle: SimpleTranslationEntries ={
  ...
  "trainerAppeared": "{{trainerName}}想要和你对战！",
  "singleWildAppeared": "一只野生{{pokemonName}}出现了！",
  "multiWildAppeared": "野生的{{pokemonName1}}和{{pokemonName2}}出现了。！",
  ...
  "switchQuestion": "要更换{{pokemonName}}吗?",
  "trainerDefeated": `你击败了{{trainerName}}！`,
  ...
  "learnMoveLimitReached": "但是，{{pokemonName}}已经学会了四个技能",
  ...
  "learnMoveForgetSuccess": "{{pokemonName}}忘记了如何使用{{moveName}}。",
